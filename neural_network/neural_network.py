...
from core.forward_propagation import forward_pass
from core.backpropagation import backward_pass
from core.backpropagation import backward_pass
from core.train import train
from core.update import update_parameters
...
'''
    ...
    def forward(self, X):
        A2, cache = forward_pass(self.W1, self.b1, self.W2, self.b2, X)
        return A2, cache
    
    def backward(self, cache, Y):
        grads = backward_pass(self.W2, cache, Y)
        return grads
    
    def update_parameters(self, grads):
        self.W1, self.b1, self.W2, self.b2 = update_parameters(
